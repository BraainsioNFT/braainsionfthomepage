...
const FAQs: Array<{ question: string; answer: string }> = [
  {
    ...
    answer:
      "NFT communities are really strong and filled with dedicated members who believe in projects enough to have money invested in it. We are adding NFTs to braains to build a community of supporters just as strong as our current playerbase. We are growing our community without sacrificing its quality.",
  },
  {
    question: "What is the current status of the NFT?",
    answer:
      "We are working full time on NFT. There's a lot of moving parts and we're still early and figuring things out. The NFTs are currently planned to start being sold in July/August (2-3 months). So we're not kidding when we say you're early.. Which makes everyone reading this a OG in the BraainsNFT timeline 🎉",
  },
  {
