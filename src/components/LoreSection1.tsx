  ...
  return (
    ...
    >
      <div className="grid grid-rows-3 grid-cols-3 gap-3 w-full max-w-[700px] m-10">
        ...
        <img src="/nfts/3.png" alt="nft-3" className="rounded-xl" />
        <img src="/nfts/4.png" alt="nft-4" className="rounded-xl" />
        <img src="/nfts/5.png" alt="nft-5" className="rounded-xl" />
        <img src="/nfts/6.png" alt="nft-6" className="rounded-xl" />
